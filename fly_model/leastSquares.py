...
plt.plot(mode_mag_range1,Y[0:5,0:1])
plt.plot(mode_mag_range2,Y[5:10,1:2])
plt.plot(mode_mag_range1,fx[0:5,0:1])
plt.plot(mode_mag_range2,fx[5:10,1:2])
ax.set_title('f_x--f_x')
ax=plt.subplot(3,3,2)
plt.plot(mode_mag_range1,Y[0:5,2:3])
plt.plot(mode_mag_range2,Y[5:10,3:4])
plt.plot(mode_mag_range1,fx[0:5,2:3])
plt.plot(mode_mag_range2,fx[5:10,3:4])
ax.set_title('f_x--f_z')
ax=plt.subplot(3,3,3)
plt.plot(mode_mag_range1,Y[0:5,4:5])
plt.plot(mode_mag_range2,Y[5:10,5:6])
plt.plot(mode_mag_range1,fx[0:5,4:5])
plt.plot(mode_mag_range2,fx[5:10,5:6])
ax.set_title('f_x--m_y')
ax=plt.subplot(3,3,4)
plt.plot(mode_mag_range1,Y[10:15,0:1])
plt.plot(mode_mag_range2,Y[15:20,1:2])
plt.plot(mode_mag_range1,fy[0:5,0:1])
plt.plot(mode_mag_range2,fy[5:10,1:2])
ax.set_title('f_z--f_x')
ax=plt.subplot(3,3,5)
plt.plot(mode_mag_range1,Y[10:15,2:3])
plt.plot(mode_mag_range2,Y[15:20,3:4])
plt.plot(mode_mag_range1,fy[0:5,2:3])
plt.plot(mode_mag_range2,fy[5:10,3:4])
ax.set_title('f_z--f_z')
ax=plt.subplot(3,3,6)
plt.plot(mode_mag_range1,Y[10:15,4:5])
plt.plot(mode_mag_range2,Y[15:20,5:6])
plt.plot(mode_mag_range1,fy[0:5,4:5])
plt.plot(mode_mag_range2,fy[5:10,5:6])
ax.set_title('f_z--m_y')
ax=plt.subplot(3,3,7)
plt.plot(mode_mag_range1,Y[20:25,0:1])
plt.plot(mode_mag_range2,Y[25:30,1:2])
plt.plot(mode_mag_range1,my[0:5,0:1])
plt.plot(mode_mag_range2,my[5:10,1:2])
ax.set_title('m+y--f_x')
ax=plt.subplot(3,3,8)
plt.plot(mode_mag_range1,Y[20:25,2:3])
plt.plot(mode_mag_range2,Y[25:30,3:4])
plt.plot(mode_mag_range1,my[0:5,2:3])
plt.plot(mode_mag_range2,my[5:10,3:4])
ax.set_title('m+y--f_z')
ax=plt.subplot(3,3,9)
plt.plot(mode_mag_range1,Y[20:25,4:5])
plt.plot(mode_mag_range2,Y[25:30,5:6])
plt.plot(mode_mag_range1,my[0:5,4:5])
plt.plot(mode_mag_range2,my[5:10,5:6])
ax.set_title('m+y--m_y')
